...
@Operation(summary = Constants.VIDEO_SAVE_CATEGORY_SUMMARY, description = Constants.VIDEO_SAVE_CATEGORY_DESCRIPTION, security = @SecurityRequirement(name = "bearerAuth"))
