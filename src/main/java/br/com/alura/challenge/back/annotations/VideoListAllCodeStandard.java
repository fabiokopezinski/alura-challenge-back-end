...
@Operation(summary = Constants.LIST_ALL_SUMMARY, description = Constants.LIST_ALL_DESCRIPTION, security = @SecurityRequirement(name = "bearerAuth"))
public @interface VideoListAllCodeStandard {
