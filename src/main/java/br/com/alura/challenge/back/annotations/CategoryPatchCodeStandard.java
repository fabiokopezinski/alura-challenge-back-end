...
@Operation(summary = Constants.VIDEO_UPDATE_CATEGORY_SUMMARY, description = Constants.VIDEO_UPDATE_CATEGORY_DESCRIPTION, security = @SecurityRequirement(name = "bearerAuth"))
